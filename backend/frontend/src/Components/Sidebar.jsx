...
function Sidebar() {
  ...
  return (
    <div className="sidebar bg-dark text-white p-3" style={{ width: "220px" }}>
      ...
      <NavLink to="/requests" className="d-block mb-2">Requests</NavLink>
      <NavLink to="/camps" className="d-block mb-2">Camps</NavLink>
      <NavLink to="/transfers" className="d-block mb-4">Transfers</NavLink>
