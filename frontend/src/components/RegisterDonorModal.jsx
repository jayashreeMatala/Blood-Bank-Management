...
if (!form.dob) {
  ...
  newErrors.dob = "Age must be between 18 to 65";
}
...
} else if (Number(form.weight) < 50) {
  newErrors.weight = "Minimum weight must be 50 kg";
}

// Last Donation Gap (3 months)
...
// ✅ If success
alert(isEdit ? "Donor Updated Successfully!" : "Donor Registered Successfully!");
await fetchDonors();
onClose();
